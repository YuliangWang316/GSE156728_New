library(dplyr)
a<-read.table("c:/Users/xjmik/Documents/scaledata&RAWdata3.txt",sep = "\t",header = TRUE,row.names = 1)
a<-a[-1,]
b<-unique(a$a.i.)
  ...
  for (j in 2:35) {
    if(i<j){
      ...
      for (d in 3:5) {
        ...
        remove(n,o,p)
        for (r in 42:44) {
          n<-cor.test(e[,d],e[,r],method = "spearman",exact = TRUE)
          o<-cor(e[,d],e[,r],method = "spearman")
          p<-data.frame(i,j,d,r,o,n$p.value)
          colnames(p)<-c("i","j","d","f","o","n")
          q<-rbind(q,p)
          remove(n,o,p)
        }
        for (s in 45:53) {
          n<-cor.test(e[,d],e[,s],method = "spearman",exact = TRUE)
          o<-cor(e[,d],e[,s],method = "spearman")
          p<-data.frame(i,j,d,s,o,n$p.value)
          colnames(p)<-c("i","j","d","f","o","n")
          q<-rbind(q,p)
          remove(n,o,p)
        }
        for (t in 54:62) {
          n<-cor.test(e[,d],e[,t],method = "spearman",exact = TRUE)
          o<-cor(e[,d],e[,t],method = "spearman")
          p<-data.frame(i,j,d,t,o,n$p.value)
          colnames(p)<-c("i","j","d","f","o","n")
          q<-rbind(q,p)
          remove(n,o,p)
        }
        for (u in 63:65) {
          n<-cor.test(e[,d],e[,u],method = "spearman",exact = TRUE)
          o<-cor(e[,d],e[,u],method = "spearman")
          p<-data.frame(i,j,d,u,o,n$p.value)
          colnames(p)<-c("i","j","d","f","o","n")
          q<-rbind(q,p)
          remove(n,o,p)
        }
        for (v in 66:68) {
          n<-cor.test(e[,d],e[,v],method = "spearman",exact = TRUE)
          o<-cor(e[,d],e[,v],method = "spearman")
          p<-data.frame(i,j,d,v,o,n$p.value)
          colnames(p)<-c("i","j","d","f","o","n")
          q<-rbind(q,p)
          remove(n,o,p)
        }
        for (w in 69:71) {
          n<-cor.test(e[,d],e[,w],method = "spearman",exact = TRUE)
          o<-cor(e[,d],e[,w],method = "spearman")
          p<-data.frame(i,j,d,w,o,n$p.value)
          colnames(p)<-c("i","j","d","f","o","n")
          q<-rbind(q,p)
          remove(n,o,p)
        }
      }
      remove(d,f,g,h,k,l,m,r,s,t,u,v,w)
      for (f in 6:8) {
        for (g in 9:17) {
        ...
        for (k in 45:53) {
          n<-cor.test(e[,f],e[,k],method = "spearman",exact = TRUE)
          o<-cor(e[,f],e[,k],method = "spearman")
          p<-data.frame(i,j,f,k,o,n$p.value)
          colnames(p)<-c("i","j","d","f","o","n")
          q<-rbind(q,p)
          remove(n,o,p)
        }
        for (l in 54:62) {
          n<-cor.test(e[,f],e[,l],method = "spearman",exact = TRUE)
          o<-cor(e[,f],e[,l],method = "spearman")
          p<-data.frame(i,j,f,l,o,n$p.value)
          colnames(p)<-c("i","j","d","f","o","n")
          q<-rbind(q,p)
          remove(n,o,p)
        }
      }
      remove(f,g,h,c,e,k,l)
    }
  }
}
write.table(q,"newcomboTotalscaleraw.txt",sep = "\t")
remove(q,i,j)
...
write.table(q,"newsingleTotalscaleraw.txt",sep = "\t")
